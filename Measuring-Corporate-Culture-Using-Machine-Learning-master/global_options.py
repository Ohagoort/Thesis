...
os.environ[
    "CORENLP_HOME"
] = "/Users/olivierhagoort/Desktop/NLP/stanford-corenlp-full-2018-10-05/"  # location of the CoreNLP models; use / to seperate folders
...
N_WORDS_DIM: int = 100  # max number of words in each dimension of the dictionary
...
DIMS: List[str] = ["AI_adoption"]
SEED_WORDS: Dict[str, List[str]] = {
    "AI_adoption": [
        "artificial_intelligence", "ai",  # Abbreviation for Artificial Intelligence
        "machine_learning", "ml",  # Abbreviation for Machine Learning
        "deep_learning", "dl",  # Abbreviation for Deep Learning
        "natural_language_processing", "nlp",  # Abbreviation for Natural Language Processing
        "robotics",  # No commonly used abbreviation
        "neural_networks", "nn",  # Abbreviation for Neural Networks
        "algorithm",  # No commonly used abbreviation
        "data_mining",  # No commonly used abbreviation
    ],
}
